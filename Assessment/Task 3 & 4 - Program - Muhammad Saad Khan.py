...
@ Title: Task 3 & 4 - Program1 - Muhammad Saad Khan
@ Version: Python 3.12.4 v2025.8.0 - Microsoft
@ Date: 2025 - 07- 08

This is the intial untested code based on the algorithm created
...
while (name == " ") and (coMark == 0) and (preMark == 0):
    ...
    preMark = int("Please Enter Your Prelim Mark out of 90: ")
